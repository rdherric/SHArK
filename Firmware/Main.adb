...
F:G$Usb0_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
T:FMain$__00010000[({0}S:S$i$0$0({2}SI:U),Z,0,0)({0}S:S$c$0$0({2}DA2,SC:U),Z,0,0)]
T:FMain$__00010001[({0}S:S$bLength$0$0({1}SC:U),Z,0,0)({1}S:S$bDescriptorType$0$0({1}SC:U),Z,0,0)({2}S:S$bcdUSB$0$0({2}ST__00010000:S),Z,0,0)({4}S:S$bDeviceClass$0$0({1}SC:U),Z,0,0)({5}S:S$bDeviceSubClass$0$0({1}SC:U),Z,0,0)({6}S:S$bDeviceProtocol$0$0({1}SC:U),Z,0,0)({7}S:S$bMaxPacketSize0$0$0({1}SC:U),Z,0,0)({8}S:S$idVendor$0$0({2}ST__00010000:S),Z,0,0)({10}S:S$idProduct$0$0({2}ST__00010000:S),Z,0,0)({12}S:S$bcdDevice$0$0({2}ST__00010000:S),Z,0,0)({14}S:S$iManufacturer$0$0({1}SC:U),Z,0,0)({15}S:S$iProduct$0$0({1}SC:U),Z,0,0)({16}S:S$iSerialNumber$0$0({1}SC:U),Z,0,0)({17}S:S$bNumConfigurations$0$0({1}SC:U),Z,0,0)]
T:FMain$__00010002[({0}S:S$bLength$0$0({1}SC:U),Z,0,0)({1}S:S$bDescriptorType$0$0({1}SC:U),Z,0,0)({2}S:S$wTotalLength$0$0({2}ST__00010000:S),Z,0,0)({4}S:S$bNumInterfaces$0$0({1}SC:U),Z,0,0)({5}S:S$bConfigurationValue$0$0({1}SC:U),Z,0,0)({6}S:S$iConfiguration$0$0({1}SC:U),Z,0,0)({7}S:S$bmAttributes$0$0({1}SC:U),Z,0,0)({8}S:S$bMaxPower$0$0({1}SC:U),Z,0,0)]
T:FMain$__00010003[({0}S:S$bLength$0$0({1}SC:U),Z,0,0)({1}S:S$bDescriptorType$0$0({1}SC:U),Z,0,0)({2}S:S$bInterfaceNumber$0$0({1}SC:U),Z,0,0)({3}S:S$bAlternateSetting$0$0({1}SC:U),Z,0,0)({4}S:S$bNumEndpoints$0$0({1}SC:U),Z,0,0)({5}S:S$bInterfaceClass$0$0({1}SC:U),Z,0,0)({6}S:S$bInterfaceSubClass$0$0({1}SC:U),Z,0,0)({7}S:S$bInterfaceProtocol$0$0({1}SC:U),Z,0,0)({8}S:S$iInterface$0$0({1}SC:U),Z,0,0)]
T:FMain$__00010004[({0}S:S$bLength$0$0({1}SC:U),Z,0,0)({1}S:S$bDescriptorType$0$0({1}SC:U),Z,0,0)({2}S:S$bEndpointAddress$0$0({1}SC:U),Z,0,0)({3}S:S$bmAttributes$0$0({1}SC:U),Z,0,0)({4}S:S$wMaxPacketSize$0$0({2}ST__00010000:S),Z,0,0)({6}S:S$bInterval$0$0({1}SC:U),Z,0,0)]
T:FMain$__00010005[({0}S:S$bmRequestType$0$0({1}SC:U),Z,0,0)({1}S:S$bRequest$0$0({1}SC:U),Z,0,0)({2}S:S$wValue$0$0({2}ST__00010000:S),Z,0,0)({4}S:S$wIndex$0$0({2}ST__00010000:S),Z,0,0)({6}S:S$wLength$0$0({2}ST__00010000:S),Z,0,0)]
F:G$Usb0_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Usb0_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Usb0_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Usb0_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:G$Out_Packet$0$0({64}DA64,SC:U),G,0,0
S:G$In_Packet$0$0({64}DA64,SC:U),G,0,0
