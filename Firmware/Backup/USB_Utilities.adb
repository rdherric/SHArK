M:USB_Utilities
F:G$HaltEndpoint$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$EnableEndpoint$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$GetEpStatus$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$SetConfiguration$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$SetInterface$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$FIFORead$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FIFOWrite$0$0({2}DF,SV:S),Z,0,0,0,0,0
T:FUSB_Utilities$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4,SC:S),Z,0,0)]
T:FUSB_Utilities$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2,SC:S),Z,0,0)]
T:FUSB_Utilities$EP0_COMMAND[({0}S:S$bmRequestType$0$0({1}SC:U),Z,0,0)({1}S:S$bRequest$0$0({1}SC:U),Z,0,0)({2}S:S$wValue$0$0({2}ST__00010000:S),Z,0,0)({4}S:S$wIndex$0$0({2}ST__00010000:S),Z,0,0)({6}S:S$wLength$0$0({2}ST__00010000:S),Z,0,0)]
T:FUSB_Utilities$__00010000[({0}S:S$i$0$0({2}SI:U),Z,0,0)({0}S:S$c$0$0({2}DA2,SC:U),Z,0,0)]
T:FUSB_Utilities$DESCRIPTORS[({0}S:S$bStdDevDsc$0$0({18}DA18,SC:U),Z,0,0)({18}S:S$bCfg1$0$0({55}DA55,SC:U),Z,0,0)]
T:FUSB_Utilities$IF_STATUS[({0}S:S$bNumAlts$0$0({1}SC:U),Z,0,0)({1}S:S$bCurrentAlt$0$0({1}SC:U),Z,0,0)({2}S:S$bIfNumber$0$0({1}SC:U),Z,0,0)]
T:FUSB_Utilities$EP_STATUS[({0}S:S$bEp$0$0({1}SC:U),Z,0,0)({1}S:S$uNumBytes$0$0({2}SI:U),Z,0,0)({3}S:S$uMaxP$0$0({2}SI:U),Z,0,0)({5}S:S$bEpState$0$0({1}SC:U),Z,0,0)({6}S:S$pData$0$0({3}DG,SV:S),Z,0,0)({9}S:S$wData$0$0({2}ST__00010000:S),Z,0,0)]
T:FUSB_Utilities$DEVICE_STATUS[({0}S:S$bCurrentConfig$0$0({1}SC:U),Z,0,0)({1}S:S$bDevState$0$0({1}SC:U),Z,0,0)({2}S:S$bRemoteWakeupSupport$0$0({1}SC:U),Z,0,0)({3}S:S$bRemoteWakeupStatus$0$0({1}SC:U),Z,0,0)({4}S:S$bSelfPoweredStatus$0$0({1}SC:U),Z,0,0)({5}S:S$bNumInterf$0$0({1}SC:U),Z,0,0)({6}S:S$bTotalInterfDsc$0$0({1}SC:U),Z,0,0)({7}S:S$pConfig$0$0({3}DG,SC:U),Z,0,0)({10}S:S$IfStatus$0$0({3}DA1,STIF_STATUS:S),Z,0,0)]
...
S:LSetConfiguration$SelectConfig$1$1({1}SC:U),R,0,0,[r2]
S:LSetConfiguration$bReturnState$1$1({1}SC:U),R,0,0,[r3]
S:LSetConfiguration$pIfStatus$1$1({3}DG,STIF_STATUS:S),R,0,0,[]
